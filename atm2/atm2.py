...
BANK_DSA_CERTIFICATE_PUBLIC_KEY_FILE_NAME = "bank_dsa_certificate.crt"
ATM_RSA_PRIVATE_KEY_FILE_NAME = "atm2_rsa_private_key.pem"
ATM_DSA_PRIVATE_KEY_FILE_NAME = "atm2_dsa_private.key"
...
file = open(ATM_RSA_PRIVATE_KEY_FILE_NAME)
...
# load bank's DSA certificate and this atm2's DSA private key
file = open(BANK_DSA_CERTIFICATE_PUBLIC_KEY_FILE_NAME)
bankCertificateBuffer = file.read()
file.close()
bankCertificate = crypto.load_certificate(crypto.FILETYPE_PEM, bankCertificateBuffer)

file = open(ATM_DSA_PRIVATE_KEY_FILE_NAME)
...
############# ATM AUTHENTICATION ###############
# send ID of this atm2
atmSock.send("atm2".encode())
